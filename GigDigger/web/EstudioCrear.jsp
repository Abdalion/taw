        ...
        <div class="container">
            <form method="post" action="ServletEstudioGuardar?id=102" name="crearEstudio" accept-charset="UTF-8">
                ...
                <div id="filtrosEventos" style="display:none;">
                    ...
                    <input type="checkbox" name="usuariosMenoresDe18"> Usuarios menores de 18 a�os <br>
                    <br>

                    <input type="checkbox" name="usuariosMayoresDe18"> Usuarios mayores de 18 a�os <br>
                    <br>
                ...
                <div id="filtrosUsuarios" style="display:block;">
                    ...
                    <input type="checkbox" name="eventosProximos" > Eventos pr�ximos <br>
                    <br>
