...
----EVENTOS----
--PROXIMO
INSERT INTO EVENTO (TITULO, DESCRIPCION, FECHA_EVENTO, FECHA_LIMITE, PRECIO, AFORO, LIMITE_USUARIO, N_FILAS, N_ASIENTOS_FILA, ID_CREADOR) 
	VALUES ('WEEKEND', 'Festival en Torre del Mar', '2021-07-21', '2021-07-20', 50.0, 40, 4, 4, 10, 2);

--REALIZADO
INSERT INTO EVENTO (TITULO, DESCRIPCION, FECHA_EVENTO, FECHA_LIMITE, PRECIO, AFORO, LIMITE_USUARIO, N_FILAS, N_ASIENTOS_FILA, ID_CREADOR) 
	VALUES ('Melendi', 'Concierto', '2021-05-17', '2021-05-15', 20.0, 20, 2, 2, 10, 2);

INSERT INTO EVENTO (TITULO, DESCRIPCION, FECHA_EVENTO, FECHA_LIMITE, PRECIO, AFORO, LIMITE_USUARIO, N_FILAS, N_ASIENTOS_FILA, ID_CREADOR) 
	VALUES ('Los Alamos', 'Festival en la playa', '2020-07-20', '2020-07-13', 50.0, 40, 4, 4, 10, 2);
